...
If the concept you need isn't in the glossary yet, that is a signal: either you're inventing language the project doesn't use or there's a real gap for `/domain-modeling` to resolve.
